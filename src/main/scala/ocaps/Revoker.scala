...
object Revoker {
  ...
  /**
    ...
    *
    * @return new instance of revoker.
    */
  ...
  /**
    ...
    *
    * @param revokers varadic number of revokers.
    * @return A single revoker which calls revoke on all the elements on the lsit.
    */
...
/**
  ...
  */
class CapabilityException(message: String)
